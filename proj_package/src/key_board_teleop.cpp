...
int main(int argc, char *argv[]) {
  ...
  ros::Publisher command_pub = n.advertise<ackermann_msgs::AckermannDriveStamped>("/kb", 1);
  ros::Publisher mode_pub = n.advertise<std_msgs::Char> ("/mode", 1);
